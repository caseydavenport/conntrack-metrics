...
var MetricSvcSeenReplyLatency = prometheus.NewHistogramVec(
	prometheus.HistogramOpts{
		...
		Buckets:   []float64{0, .00001, .00005, .00010, .00050, .001, .0025, .005, .0075, .01, .025, .05, .1, .2, .5, 1, 5, 10},
	},
	[]string{"node"},
)

var MetricSvcSeenReplyLatencySummary = prometheus.NewSummaryVec(
...
var MetricSvcTCPFinLatency = prometheus.NewHistogramVec(
	prometheus.HistogramOpts{
		...
		Buckets:   []float64{0, .001, .005, .01, .025, .05, 0.075, .1, .125, .15, .175, .2, .3, .4, .5, 1, 3, 5, 10, 20, 50},
	},
	[]string{"node"},
)

var MetricSvcTCPFinLatencySummary = prometheus.NewSummaryVec(
	prometheus.SummaryOpts{
		Namespace:  "conntrack_monitoring",
...
var MetricRcvMsgsSpeed = prometheus.NewHistogramVec(
	prometheus.HistogramOpts{
		...
		Buckets:   []float64{10, 100, 1000, 10000, 12000, 15000, 17000, 20000, 25000, 30000},
	},
	[]string{"node"},
)
